...
Soybeanss and oats are always preceded by corn according to Thompson's rotation system. However, corn is preceded by either hay or soybeanss, and hay is preceded by either hay or oats. The boxplots below illustrate how the yield for corn and hay vary based on the crop that was planted on the same field during the previous year.
...
After examining how each individual expense related to the yield of each crop, we found four interesting relationships: three having to do with corn and one having to do with soybeans.
