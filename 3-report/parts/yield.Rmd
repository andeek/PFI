...
Below is are boxplots of the yield for each crop based on the crop that was planted on the same field during the previous year. Soy beans and oats always followed corn according to Thompson's rotation system. What is interesting is how the yields for corn and hay vary.
...
When oats were planted in the previous year, the yield for corn is signficantly lower than when hay or soy beans were planted the year before. However there is not much of a difference between the yield of corn when the previous crop was hay versus soy beans. The yield of hay is also slightly higher when the previous crop was oats, as opposed to hay.

A future study could further examine these variations by also looking at how the yields of soy beans and oats are effected if the previous crop is something other than corn. Obviously the knowledge that one crop performs signficantly better than when a certain crop is planted on the same field the year before could be very valuable information. This could help the farmer develop an optimized rotation strategy.
