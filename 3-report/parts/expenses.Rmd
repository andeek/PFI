...
```{r ,warning=FALSE, message=FALSE, echo=FALSE, fig.cap = "\\label{fig:diff_corn}Difference (Boone - Thompson) in average expenses for corn over time. For both corn and soybeans the biggest cost discrepancy is for fertilizer and herbicide. "}
dat %>% 
  filter(item_type == "Expense") %>%
...
These extra costs are for tillage (spring and fall), and applying Nitrogen to the corn fields.  The Nitrogen expenses drop precipitously in 1994, and then gradually increase to an extra $12/acre in 2011.  Nitrogen was not applied to the Boone soybean fields.  

Spring and fall tillage also added approximately $10/acre to the Boone farm.  As part of his farming practices, Thompson does not till his land.
