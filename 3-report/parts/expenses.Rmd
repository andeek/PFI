...
The extra expenses that Boone incurs are for tillage (spring and fall), and applying Nitrogen to the soil where corn is planted.  The Nitrogen expenses drop preciptiously in 1994, and then gradually increase to an extra $12/acre in 2011.  Nitogen is not applied to the Boone soybean fields.  
...
Although Thompson has lower expenses than Boone, it could be a moot point if his yield is substanitally lower than Boone, too.  Therefore, we will also compare yields to see if Thompson is able to still produce despite spending less on fertilizers and herbicide.  
