...
Can we just get Labor Return alone?  If Thompson requires significantly more labor than Boone, it's essential to include. 
```{r}
  labor<-pfi[complete.cases(pfi),] %>% 
...
```
Still confused about the difference between these two variables.  It doesn't seem like it's just management costs.  It would be nice to get managment and labor costs alone.
