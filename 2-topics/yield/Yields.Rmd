...
For each year and crop, take out all variables that are the same for Boone and Thompson. Then use those variables to predict 
the difference in yields for that crop and year.
